...
const BuyerMessages: React.FC = () => {
  ...
  // Parse query parameters if coming from car details or showroom page
  useEffect(() => {
    ...
    if (carId && showroomId) {
      // In a real app, we would fetch the showroom owner ID here
      // For now, let's just use the showroom ID as the seller ID
      setSelectedConversation(parseInt(showroomId));
    }
  }, [location]);
    ...
    messages.forEach((message: any) => {
      ...
      if (!conversationMap.has(otherUserId)) {
        conversationMap.set(otherUserId, {
          userId: otherUserId,
          userName: `Seller #${otherUserId}`, // In a real app, you'd fetch user names
                ...
                {selectedConversation && currentConversation ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-full text-center p-8">
                    ...
                    <p className="text-sm text-gray-500 max-w-md mt-2">
                      Select a conversation from the list or start a new one by contacting a seller from a car listing page.
                    </p>
                    <Button className="mt-6" asChild>
                      <Link href="/cars">
                        <Car className="h-4 w-4 mr-2" />
